...
urlpatterns = defaults.patterns(
  ...
  defaults.url(
      r'^add/$', controllers.CreateUser.as_view(
          template_name='add.html', form_class=model.UserForm, model=model.User,
          success_url='/'),
      name='add'),
  defaults.url(
  ...
  defaults.url(
      r'^tweets/$', controllers.GetTweets.as_view(template_name='tweets.html'),
      name='tweets'),
  defaults.url(
      r'^users/$', controllers.RefreshUsers.as_view(template_name='users.html'),
      name='users'),
  defaults.url(
